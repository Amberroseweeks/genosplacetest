...
/**
 * Title: Footer links
 * Slug: genos-place-test/footer-links
 * Categories: text
 * Inserter: no
 *
...
<?php esc_html_e( 'Copyright', 'genos-place-test' ) . ' ' . date_i18n( _x( 'Y', 'copyright date format', 'genos-place-test' ) ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:site-title {"level":0, "fontSize":"extra-small"} /-->
<?php echo genos_place_test_privacy(); ?>
</div><!-- /wp:group -->

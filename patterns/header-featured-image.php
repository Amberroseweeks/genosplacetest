 ...
 * Slug: genos-place-test/post-header-featured-image
 * Categories: featured
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:post-title {"textColor":"white","className":"is-style-genos-place-test-text-shadow","fontSize":"x-large"} /-->
